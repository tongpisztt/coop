...
public class StudentConstant {
    public static final String ERROR_NOT_FOUND_STUDENT_IN_DB = "Not found student data in database!";
    public static final String ERROR_NOT_FOUND_ANY_STUDENT_IN_DB = "Not found any student data in database!";
